...
export default function Dashboard() {
  ...
  const stats = isDeveloper
    ? [
        { label: "Active Projects", value: "3", icon: Code, color: "text-blue-600" },
        { label: "Total Testers", value: "24", icon: Users, color: "text-green-600" },
        { label: "Avg Rating", value: "4.8", icon: Star, color: "text-yellow-600" },
        { label: "This Month", value: "$1,200", icon: DollarSign, color: "text-purple-600" },
      ]
    : [
        { label: "Active Tests", value: "2", icon: TestTube, color: "text-blue-600" },
        { label: "Completed", value: "18", icon: TrendingUp, color: "text-green-600" },
        { label: "Rating", value: "4.9", icon: Star, color: "text-yellow-600" },
        { label: "Earnings", value: "$850", icon: DollarSign, color: "text-purple-600" },
      ]
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <nav className="hidden md:flex space-x-6">
                ...
                >
                  {isDeveloper ? "My Projects" : "Available Projects"}
                </button>
                <button
      ...
      <div className="container mx-auto px-4 py-8">
          ...
          <div className="space-y-8">
            ...
            <div className="flex items-center justify-between">
              ...
              <Button asChild className="bg-blue-600 hover:bg-blue-700">
                <Link href={isDeveloper ? "/projects/create" : "/projects"}>
                  <Plus className="w-4 h-4 mr-2" />
                  {isDeveloper ? "New Project" : "Browse Projects"}
                </Link>
              </Button>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    {isDeveloper ? "Your latest project activities" : "Your recent testing work"}
                  </CardDescription>
                </CardHeader>
                <CardContent>
                      ...
                      <div key={project.id} className="flex items-center justify-between p-4 border rounded-lg">
                        ...
                        <div className="text-right">
                          <p className="text-sm font-medium text-gray-900">
                            {isDeveloper && project.applicants && `${project.applicants} applicants`}
                            {!isDeveloper && project.client}
                          </p>
        ...
        {activeTab === "projects" && (
          <div className="space-y-6">
            <div className="flex items-center justify-between">
              <h2 className="text-2xl font-bold text-gray-900">{isDeveloper ? "My Projects" : "Available Projects"}</h2>
              {isDeveloper && (
                <Button asChild className="bg-blue-600 hover:bg-blue-700">
                    ...
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        ...
                        <p className="text-gray-600 mb-4">
                          {isDeveloper
                            ? "Looking for experienced testers to help validate our mobile application before launch."
                            : "Test a modern e-commerce mobile application focusing on user experience and functionality."}
                        </p>
                        <div className="flex items-center space-x-4">
                          {isDeveloper && project.applicants && (
                            <span className="text-sm text-gray-600">{project.applicants} applicants</span>
                          )}
                          {!isDeveloper && project.client && (
                      ...
                      <div className="flex space-x-2">
                        ...
                        {!isDeveloper && project.status === "active" && (
